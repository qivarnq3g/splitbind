  ...
  return (
    ...
    >
      <div className="landing-section-body">
        ...
        <p>
          Bạn tải tệp cần kiểm tra lên. Hệ thống băm tệp đó bằng SHA-256 và so giá
          trị băm với các bản đã cấp phát, đồng thời kiểm tra chữ ký số Ed25519 trên
          manifest tương ứng.
        </p>
        <p>
          ...
          còn nguyên vẹn hay không. Những gì hệ thống chưa kết luận được thì nêu
          riêng, thay vì gộp vào một phán quyết chung.
        </p>
      </div>
    </section>
  );
