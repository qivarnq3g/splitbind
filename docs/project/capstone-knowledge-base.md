...
| Trên đường đi thật của sản phẩm, mọi phép biến đổi làm đổi điểm ảnh đều khiến hệ thống mất khả năng truy vết | `[Experimentally observed]` & `[Limitation]` | Năm phép thử âm tính ngày 14/09/2026 qua đúng giao diện web; ảnh chụp màn hình ở `docs/project/report-assets/evidence/2026-09-14-v0.2.1/`; bảng ở Mục 4.2.4.5 | Đã kiểm chứng: nén JPEG 70 trượt trên cả ba vật mang, và thu nhỏ 0.75 không nén cũng trượt. Hai giả thuyết bào chữa, vật mang yếu và chỉ nén mới phá tín hiệu, đều bị chính các phép thử sau bác bỏ. |
