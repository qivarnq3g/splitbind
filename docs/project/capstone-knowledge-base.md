...
`[Established theory]` (tổng hợp từ [3] và [9])
...
`[Established theory]` (tổng hợp từ [18], [3], [8] và [4])
...
- Hai giáo trình tiếng Việt không có nội dung nào về thủy vân số hay giấu tin. Toàn bộ
  phần lý thuyết thủy vân của báo cáo dựa vào [3] Cox và cộng sự, cùng hai bài tổng quan
...
- Hai giáo trình đó khớp đúng mục [9] và [20] trong tài liệu tham khảo: [9] Hoàng Xuân Dậu,
  *Giáo trình Cơ sở An toàn Thông tin*, Học viện Công nghệ Bưu chính Viễn thông, 2020;
  [20] TS. Thái Thanh Tùng, *Giáo trình Mật mã học và Hệ thống Thông tin An toàn*, Nhà xuất
...
- Thư mục "Tài liệu tham khảo" của môn chỉ có đúng một tệp:
  ...
  cáo thành [8], cùng với [4] là bài tổng quan steganography còn lại ở thư mục gốc dự án.
...
### Công trình 1: thủy vân ảnh trang văn bản chống chụp màn hình [6]
...
### Công trình 2: thủy vân chống chụp màn hình dùng điểm đặc trưng [5]
...
### Công trình 3: thư viện đang được dùng trong sản phẩm thật [17]
