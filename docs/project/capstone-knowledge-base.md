...
Bốn hàng còn lại cho một kết luận thẳng thắn: **trên đường đi thật của sản phẩm, nén JPEG chất lượng 70 làm mất khả năng truy vết, ở cả ba vật mang.** Nhóm đã thử lần lượt đúng để loại trừ giả thuyết vật mang. Giả thuyết ban đầu là ảnh mẫu quá phẳng nên ít chỗ giấu tín hiệu; trang chữ dày và trang PDF bác bỏ giả thuyết đó, vì chúng nhiều kết cấu hơn hẳn mà vẫn trượt.

`[Limitation]` Điều này không mâu thuẫn với con số 9/12 trước JPEG-70 ở Mục 4.2.1.1, nhưng nó buộc phải đọc con số ấy đúng phạm vi. Benchmark gọi thẳng bộ giải mã, truyền sẵn số trang và làm việc trên khung ảnh chuẩn tắc. Dịch vụ nhận một tấm ảnh trần thì không có hai thứ đó và phải tự đoán hình học. Chính Mục 4.2.4.4 đã nêu trước điều này khi nói bảng độ bền mô tả thư viện chứ chưa mô tả sản phẩm; năm phép thử ở đây là phần kiểm chứng thực nghiệm cho nhận định đó.

`[Limitation]` Phát biểu đúng về năng lực truy vết của bản đang chạy vì thế là: hệ thống truy được nguồn khi tệp đổi biểu diễn nhị phân mà nội dung ảnh không đổi, ví dụ lưu lại sang định dạng không mất dữ liệu. Nhóm chưa quan sát được lần truy vết thành công nào sau khi tệp bị nén mất dữ liệu trên đường đi thật của sản phẩm. Mọi câu trong báo cáo này nói rằng bản đang chạy truy vết được tệp bị nén đều phải hiểu theo phạm vi đó.
...
| Trên đường đi thật của sản phẩm, nén JPEG 70 làm mất khả năng truy vết ở cả ba vật mang | `[Experimentally observed]` & `[Limitation]` | Bốn phép thử ngày 14/09/2026 qua đúng giao diện web; ảnh chụp màn hình ở `docs/project/report-assets/evidence/2026-09-14-v0.2.1/`; bảng ở Mục 4.2.4.5 | Đã kiểm chứng: ảnh nền phẳng, trang chữ dày và trang render từ PDF đều trượt. Giả thuyết vật mang yếu đã bị chính hai phép thử sau bác bỏ. |
