...
* **Cấp độ C (Production Capability Layer):** Trên môi trường vận hành thực tế, hệ thống luôn áp dụng cơ chế xác thực toàn vẹn tệp chính xác (Exact-file integrity qua SHA-256) kèm chữ ký Ed25519 trên Manifest. Từ ngày 12/09/2026, nhóm bật thêm phân hệ thủy vân trên chính hệ thống đang chạy: mỗi bản cấp phát nhúng thủy vân V2 và mỗi lần xác minh đều chạy bộ giải mã.
  ...
  * Ngày 13 và 14/09, nhóm tìm ra nguyên nhân gốc thứ ba và sửa. Bản phát hành `integrity-v0.2.1` đang chạy nhận cả PDF, PNG và JPEG ở cả hai chiều cấp phát và xác minh. Về truy vết, phép đo qua đúng giao diện người dùng cho thấy hệ thống truy được nguồn khi tệp đổi biểu diễn nhị phân mà nội dung ảnh không đổi, còn khi tệp bị nén mất dữ liệu thì nhóm chưa quan sát được lần truy vết thành công nào. Chi tiết, bảng số liệu và ranh giới ở Mục 4.2.4.
...
##### Sáu phép thử qua đúng giao diện người dùng, ngày 14/09/2026

*Số liệu đo thực nghiệm* Phép kiểm vừa nêu gọi thẳng hàm bên trong container, tức vẫn là một phép đo về thư viện. Để biết đường đi thật của sản phẩm làm được gì, nhóm cấp phát tài liệu trên chính hệ thống đang chạy, tải bản cấp phát về, biến đổi, rồi nộp lại qua đúng biểu mẫu xác minh trên web. Ba vật mang được dùng để tránh kết luận dựa trên một loại ảnh duy nhất: một ảnh gần như toàn nền phẳng, một trang chữ dày đặc nhiều kết cấu, và một trang render từ tệp PDF do hệ thống cấp phát. Các phép biến đổi cũng được chọn để tách riêng hai nguyên nhân, một bên là mất đồng bộ hình học và một bên là hỏng vật mang, đúng cách phân loại ở Mục 4.2.2.2.
...
Hàng thứ nhất là nội dung của Hình 4.4 và là kết quả dương tính duy nhất: mã băm của tệp nộp lên khác hẳn mã băm đã ký, giao diện ghi rõ "hai giá trị khác nhau", vậy mà hệ thống vẫn chỉ đúng bản cấp phát đã sinh ra tệp đó. Kết luận ấy không thể đến từ đối chiếu mã băm, nên nó chứng minh chuỗi cấp phát, nhúng, lưu trữ, giải mã và tra cứu hồ sơ chạy thông suốt trên môi trường thật. Đó là một khẳng định về tính đúng đắn của dây chuyền, không phải về độ bền.

Năm hàng còn lại cho một kết luận thẳng thắn: **trên đường đi thật của sản phẩm, mọi phép biến đổi làm đổi điểm ảnh đều khiến hệ thống mất khả năng truy vết.** Nhóm loại trừ giả thuyết bằng cách thử lần lượt. Giả thuyết thứ nhất là ảnh mẫu quá phẳng nên ít chỗ giấu tín hiệu; trang chữ dày và trang PDF bác bỏ nó, vì chúng nhiều kết cấu hơn hẳn mà vẫn trượt. Giả thuyết thứ hai là chỉ riêng nén mới phá tín hiệu, còn thu nhỏ thuần tuý thì phục hồi khung ảnh sẽ cứu được, đúng như Bảng 4.7 đã đo với bộ mã hoá đối chứng [19]; hàng thu nhỏ không nén bác bỏ nốt giả thuyết này.

Vậy ranh giới đo được của bản đang chạy hẹp hơn nhiều so với mọi bảng độ bền trong báo cáo: nó chỉ truy được nguồn khi điểm ảnh không thay đổi.
...
*Giới hạn đã nhận diện* Phát biểu đúng về năng lực truy vết của bản đang chạy vì thế là: hệ thống truy được nguồn khi tệp đổi biểu diễn nhị phân mà từng điểm ảnh giữ nguyên, ví dụ lưu lại sang một định dạng không mất dữ liệu. Nhóm chưa quan sát được lần truy vết thành công nào sau bất kỳ phép biến đổi điểm ảnh nào trên đường đi thật của sản phẩm, kể cả thu nhỏ không nén. Mọi câu trong báo cáo này nói rằng bản đang chạy truy vết được tệp đã bị nén hay thu nhỏ đều phải hiểu theo phạm vi đó.
...
| Trên đường đi thật của sản phẩm, mọi phép biến đổi làm đổi điểm ảnh đều khiến hệ thống mất khả năng truy vết | *Số liệu đo thực nghiệm* và *Giới hạn đã nhận diện* | Năm phép thử âm tính ngày 14/09/2026 qua đúng giao diện web; ảnh chụp màn hình ở `docs/project/report-assets/evidence/2026-09-14-v0.2.1/`; bảng ở Mục 4.2.4.5 | Đã kiểm chứng: nén JPEG 70 trượt trên cả ba vật mang, và thu nhỏ 0.75 không nén cũng trượt. Hai giả thuyết bào chữa, vật mang yếu và chỉ nén mới phá tín hiệu, đều bị chính các phép thử sau bác bỏ. |
