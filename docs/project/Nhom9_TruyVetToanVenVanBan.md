...
*Giới hạn đã nhận diện* Điều này không mâu thuẫn với con số 9/12 trước JPEG-70 ở Mục 4.2.1.1, nhưng nó buộc phải đọc con số ấy đúng phạm vi. Benchmark gọi thẳng bộ giải mã, truyền sẵn số trang và làm việc trên khung ảnh chuẩn tắc. Dịch vụ nhận một tấm ảnh trần thì không có hai thứ đó và phải tự đoán hình học. Chính Mục 4.2.4.4 đã nêu trước điều này khi nói bảng độ bền mô tả thư viện chứ chưa mô tả sản phẩm; năm phép thử ở đây là phần kiểm chứng thực nghiệm cho nhận định đó.

*Giới hạn đã nhận diện* Phát biểu đúng về năng lực truy vết của bản đang chạy vì thế là: hệ thống truy được nguồn khi tệp đổi biểu diễn nhị phân mà nội dung ảnh không đổi, ví dụ lưu lại sang định dạng không mất dữ liệu. Nhóm chưa quan sát được lần truy vết thành công nào sau khi tệp bị nén mất dữ liệu trên đường đi thật của sản phẩm. Mọi câu trong báo cáo này nói rằng bản đang chạy truy vết được tệp bị nén đều phải hiểu theo phạm vi đó.
